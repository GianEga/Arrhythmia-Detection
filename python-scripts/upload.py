...
def extract_compressed_file(file_to_extract, destination_folder):
    ...
    # progress_message = f"Extracting file '{file_to_extract}' to '{destination_folder}'"
...
#     # Return a final message after the extraction is complete
#     yield "Extraction process complete"
