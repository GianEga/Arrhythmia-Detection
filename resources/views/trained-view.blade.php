...
<body>
    ...
    <script>
            ...
            $('#uploadBtn').click(function(){
                ...
                $.ajax({
                    ...
                    success: function(response){
                        ...
                        // Update HTML content to include directory path
                        htmlContent += '<style>';
                        htmlContent += '.image-container { text-align: center; }'; // Center-align text within the image container
                        htmlContent += '.image-title { font-size: 12px; text-align: center; }'; // Define CSS class for image titles
                        htmlContent += '</style>';
                        htmlContent += '<div class="image-container">';
                        htmlContent += '<div>'; // Start a new div to group h5 and a together
                        ...
                        htmlContent += '</a>';
                        htmlContent += '</div>'; // End of div for Time Domain Plot
                        htmlContent += '<div>'; // Start a new div to group h5 and a together
                        ...
                        htmlContent += '</a>';
                        htmlContent += '</div>'; // End of div for Frequency Domain Plot
                        htmlContent += '</div>'; // End of image-container

                        // Append the HTML content to the response container
        ...
        // $(document).ready(function){
        //     $('.F:\\vicky\\DeteksiAritmea\\storage\\app\\public\\1706983966_abnormal_0\\fdPlot.png').magnificPopup({type:'image'});
        // }
    </script>
